export class ui{
    ...
    displayGames(dataApp){
    var cartoona =``;
    for(var i=0 ;i<dataApp.length;i++){
        cartoona+=`
        <div class="col-lg-3 col-md-6 col-sm-12 mb-4 d-flex align-content-center justify-content-center ">
            
        <div class="card"      data-id="${dataApp[i].id}">
            <div class="content">
              <div class="back">
                <div class="back-content">
                      <g stroke-width="0" id="SVGRepo_bgCarrier"></g>
                      <img src="${dataApp[i].thumbnail}" >
                  <g id="">
              ...
              <div class="front">
                ...
                <div class="front-content">
                  <small class="badge">GAME</small>
                  <div class="description">
                    <div class="title">
                      <h3 class=" moaz">
                        <strong>${dataApp[i].title.split(" ", 1)}</strong>
                        <svg fill-rule="nonzero" height="190px" width="15px" viewBox="0,0,256,256" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><g style="mix-blend-mode: normal" text-anchor="none" font-size="none" font-weight="none" font-family="none" stroke-dashoffset="0" stroke-dasharray="" stroke-miterlimit="10" stroke-linejoin="miter" stroke-linecap="butt" stroke-width="1" stroke="none" fill-rule="nonzero" fill="#20c997"><g transform="scale(10,10)"><path d="M25,27l-9,-6.75l-9,6.75v-23h18z"></path></g></g></svg>
                      </h3>
                    </div>
                    <p class="zoz   opacity-50">
                    ${dataApp[i].short_description.split(" ", 4)}
                   </p>
                    <button class="free">FREE</button>
                    <footer class="card-footer hstack justify-content-between">
                      <span class="badge badge-color ">${dataApp[i].genre}</span>
                      <span class="badge badge-color">${dataApp[i].platform}</span>
                   </footer>
                  </div>
                </div>
              </div>
...
//////////dispaly two///
 ...
 <div class="col-md-8">
    ...
    // document.querySelector(".main2").innerHTML = content;
    document.getElementById('main2').innerHTML=content;
    ////////////////////////////////
